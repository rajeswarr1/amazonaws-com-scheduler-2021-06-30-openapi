...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_tags_ResourceArn",
		mcp.WithDescription("Lists the tags associated with the Scheduler resource."),
		mcp.WithString("ResourceArn", mcp.Required(), mcp.Description("The ARN of the EventBridge Scheduler resource for which you want to view tags.")),
	)
