...
func CreatescheduleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.CreateScheduleOutput
...
func CreateCreatescheduleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_schedules_Name",
		mcp.WithDescription("Creates the specified schedule."),
		mcp.WithString("Name", mcp.Required(), mcp.Description("The name of the schedule that you are creating.")),
		...
		mcp.WithString("GroupName", mcp.Description("Input parameter: The name of the schedule group to associate with this schedule. If you omit this, the default schedule group is used.")),
		mcp.WithString("KmsKeyArn", mcp.Description("Input parameter: The Amazon Resource Name (ARN) for the customer managed KMS key that EventBridge Scheduler will use to encrypt and decrypt your data.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatescheduleHandler(cfg),
	}
}
