# Amazon EventBridge Scheduler MCP Server

This MCP (Model Content Protocol) server provides access to Amazon EventBridge Scheduler API functionality through HTTP, HTTPS, and STDIO transport modes.
